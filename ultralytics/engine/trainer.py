...
class BaseTrainer:
    ...
    Attributes:
        ...
        csv (Path): Path to results_duibi CSV file.
    """
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        self.csv = self.save_dir / "results_duibi.csv"
        self.plot_idx = [0, 1, 2]
    ...
    def _setup_train(self, world_size):
        ...
        for k, v in self.model.named_parameters():
            # v.register_hook(lambda x: torch.nan_to_num(x))  # NaN to 0 (commented for erratic training results_duibi)
    ...
    def _do_train(self, world_size=1):
        ...
        LOGGER.info(
            ...
            f"Logging results_duibi to {colorstr('bold', self.save_dir)}\n"
