...
"""
Ultralytics Results, Boxes and Masks classes for handling inference results_duibi.
...
class BaseTensor(SimpleClass):
    ...
    def __init__(self, data, orig_shape) -> None:
        ...
        Example:
            ```python
            import torch
            from ultralytics.engine.results_duibi import BaseTensor
    ...
    def __len__(self):  # override len(results_duibi)
...
class Results(SimpleClass):
    """
    A class for storing and manipulating inference results_duibi.
    ...
    Methods:
        update(boxes=None, masks=None, probs=None, obb=None): Updates object attributes with new detection results_duibi.
        cpu(): Returns a copy of the Results object with all tensors on CPU memory.
        numpy(): Returns a copy of the Results object with all tensors as numpy arrays.
        cuda(): Returns a copy of the Results object with all tensors on GPU memory.
        to(*args, **kwargs): Returns a copy of the Results object with tensors on a specified device and dtype.
        new(): Returns a new Results object with the same image, path, and names.
        plot(...): Plots detection results_duibi on an input image, returning an annotated image.
        show(): Show annotated results_duibi to screen.
        save(filename): Save annotated results_duibi to file.
        verbose(): Returns a log string for each task, detailing detections and classifications.
        save_txt(txt_file, save_conf=False): Saves detection results_duibi to a text file.
        save_crop(save_dir, file_name=Path("im.jpg")): Saves cropped detection images.
        tojson(normalize=False): Converts detection results_duibi to JSON format.
    """
    ...
    def __init__(
        ...
        """
        Initialize the Results class for storing and manipulating inference results_duibi.
        ...
        Example:
            ```python
            results_duibi = model("path/to/image.jpg")
            ```
        """
    ...
    def __getitem__(self, idx):
        """Return a Results object for a specific index of inference results_duibi."""
    ...
    def update(self, boxes=None, masks=None, probs=None, obb=None):
        """Updates detection results_duibi attributes including boxes, masks, probs, and obb with new data."""
    ...
    def plot(
        ...
        """
        Plots the detection results_duibi on an input RGB image. Accepts a numpy array (cv2) or a PIL Image.
        ...
        Example:
            ...
            results_duibi = model('bus.jpg')  # results_duibi list
            for r in results_duibi:
                im_array = r.plot()  # plot a BGR numpy array of predictions
                im = Image.fromarray(im_array[..., ::-1])  # RGB PIL image
                im.show()  # show image
                im.save('results_duibi.jpg')  # save image
            ```
        """
        ...
        # Plot Classify results_duibi
        if pred_probs is not None and show_probs:
            text = ",\n".join(f"{names[j] if names else j} {pred_probs.data[j]:.2f}" for j in pred_probs.top5)
            x = round(self.orig_shape[0] * 0.03)
            annotator.text([x, x], text, txt_color=(255, 255, 255))  # TODO: allow setting colors

        # Plot Pose results_duibi
    ...
    def show(self, *args, **kwargs):
        """Show the image with annotated inference results_duibi."""
        self.plot(show=True, *args, **kwargs)

    def save(self, filename=None, *args, **kwargs):
        """Save annotated inference results_duibi image to file."""
        if not filename:
    ...
    def verbose(self):
        """Returns a log string for each task in the results_duibi, detailing detection and classification outcomes."""
        log_string = ""
        probs = self.probs
        boxes = self.boxes
        if len(self) == 0:
    ...
    def save_txt(self, txt_file, save_conf=False):
        """
        Save detection results_duibi to a text file.
        ...
        Notes:
            ...
            - Existing contents of the file will not be overwritten; new results_duibi will be appended.
        """
        is_obb = self.obb is not None
    ...
    def summary(self, normalize=False, decimals=5):
        """Convert inference results_duibi to a summarized dictionary with optional normalization for box coordinates."""
    ...
    def tojson(self, normalize=False, decimals=5):
        """Converts detection results_duibi to JSON format."""
        import json
