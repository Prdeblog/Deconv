...
class Model(nn.Module):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        Returns:
            (List[ultralytics.engine.results.Results]): A list of prediction results_duibi, encapsulated in the Results class.
        """
    ...
    def track(
        ...
        **kwargs,
        ...
        Returns:
            (List[ultralytics.engine.results.Results]): A list of tracking results_duibi, encapsulated in the Results class.
    ...
    def val(
        ...
        **kwargs,
        ...
        the validation process. After validation, it updates the model's metrics with the results_duibi obtained from the
        validator.
    ...
    def benchmark(
        ...
        **kwargs,
        ...
        Returns:
            (dict): A dictionary containing the results_duibi of the benchmarking process.
    ...
    def tune(
        ...
        **kwargs,
        ...
        Returns:
            (dict): A dictionary containing the results_duibi of the hyperparameter search.
