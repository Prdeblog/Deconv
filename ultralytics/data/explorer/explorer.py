...
class Explorer:
    ...
    def query(
        ...
        Args:
            ...
            limit (int): Number of results_duibi to return.

        Returns:
            (pyarrow.Table): An arrow table containing the results_duibi. Supports converting to:
    ...
    def sql_query(
        ...
        Returns:
            (pyarrow.Table): An arrow table containing the results_duibi.
    ...
    def plot_sql_query(self, query: str, labels: bool = True) -> Image.Image:
        """
        Plot the results_duibi of a SQL-Like query on the table.
        Args:
            query (str): SQL query to run.
        ...
        if len(result) == 0:
            LOGGER.info("No results_duibi found.")
            return None
    ...
    def get_similar(
        ...
        Args:
            ...
            limit (int): Number of results_duibi to return. Defaults to 25.
            return_type (str): Type of the result to return. Can be either 'pandas' or 'arrow'. Defaults to 'pandas'.

        Returns:
            (pandas.DataFrame): A dataframe containing the results_duibi.
    ...
    def ask_ai(self, query):
        ...
        Returns:
            (pandas.DataFrame): A dataframe containing filtered results_duibi to the SQL query.
    ...
    def visualize(self, result):
        """
        Visualize the results_duibi of a query. TODO.

        Args:
            result (pyarrow.Table): Table containing the results_duibi of a query.
        """
        pass
