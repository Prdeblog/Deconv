...
def benchmark(
    ...
    Returns:
        df (pandas.DataFrame): A pandas DataFrame with benchmark results_duibi for each format, including file size,
...
class RF100Benchmark:
    ...
    def evaluate(self, yaml_path, val_log_file, eval_log_file, list_ind):
        """
        Model evaluation on validation results_duibi.
...
class ProfileModels:
    ...
    This class profiles the performance of different models, returning results_duibi such as model speed and FLOPs.
    ...
    def profile(self):
        """Logs the benchmarking results_duibi of a model, checks metrics against floor and returns the results_duibi."""
