...
def check_amp(model):
    ...
    fail, it means there are anomalies with AMP on the system that may cause NaN losses or zero-mAP results_duibi, so AMP will
    ...
    def amp_allclose(m, im):
        """All close FP32 vs AMP results_duibi."""
    ...
    try:
        ...
        LOGGER.warning(
            ...
            f"NaN losses or zero-mAP results_duibi, so AMP will be disabled during training."
        )
        return False
    return True
