...
class Metric(SimpleClass):
    ...
    Methods:
        ...
        mean_results(): Mean of results_duibi, returns mp, mr, map50, map.
        class_result(i): Class-aware result, returns p[i], r[i], ap50[i], ap[i].
        maps(): mAP of each class. Returns: Array of mAP scores, shape: (nc,).
        fitness(): Model fitness as a weighted combination of metrics. Returns: Float.
        update(results_duibi): Update metric attributes with new evaluation results_duibi.
    """
    ...
    def mean_results(self):
        """Mean of results_duibi, return mp, mr, map50, map."""
    ...
    def update(self, results):
        """
        Updates the evaluation metrics of the model with a new set of results_duibi.
        ...
        Side Effects:
            ...
            on the values provided in the `results_duibi` tuple.
        """
        (
            self.p,
            self.r,
...
class DetMetrics(SimpleClass):
    ...
    Attributes:
        ...
        box (Metric): An instance of the Metric class for storing the results_duibi of the detection metrics.
        speed (dict): A dictionary for storing the execution time of different parts of the detection process.

    Methods:
        process(tp, conf, pred_cls, target_cls): Updates the metric results_duibi with the latest batch of predictions.
    ...
    def process(self, tp, conf, pred_cls, target_cls):
        """Process predicted results_duibi for object detection and update metrics."""
...
class SegmentMetrics(SimpleClass):
    ...
    def mean_results(self):
        """Return the mean metrics for bounding box and segmentation results_duibi."""
        return self.box.mean_results() + self.seg.mean_results()

    def class_result(self, i):
        """Returns classification results_duibi for a specified class index."""
    ...
    @property
    def results_dict(self):
        """Returns results_duibi of object detection model for evaluation."""
        return dict(zip(self.keys + ["fitness"], self.mean_results() + [self.fitness]))
...
class PoseMetrics(SegmentMetrics):
    ...
    def mean_results(self):
        """Return the mean results_duibi of box and pose."""
        return self.box.mean_results() + self.pose.mean_results()

    def class_result(self, i):
        """Return the class-wise detection results_duibi for a specific class i."""
