...
HELP_MSG = """
    ...
    2. Use the Python SDK:
        ...
        # Use the model
        results_duibi = model.train(data="coco8.yaml", epochs=3)  # train the model
        results_duibi = model.val()  # evaluate model performance on the validation set
        results_duibi = model('https://ultralytics.com/images/bus.jpg')  # predict on an image
